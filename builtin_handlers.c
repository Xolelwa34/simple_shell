...
/**
 * assist-all - Presents all the possibilities of  builtin shell by commands
 */
...
/**
 * assist_alias - It presents the information on shell byready- builtin command 'alias'
 */
...
/**
 * assist_cd - this presents the information on the shell bythe ready- built command 'cd'
 */
void assist_cd(void)
{
...
/**
 * assist_exit - It presents the information on  shell by builtin command 'exit'
 */
...
/**
 * assist_inuse - Presents the information on shell bythe ready- built command 'inuse'
 */
void assist_inuse(void)
{
	char *msg = "assist: inuse\n\tSee all possible Shellby builtin commands.\n";
